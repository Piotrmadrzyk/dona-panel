...
END $pilotcheck$;
ROLLBACK;
SELECT true AS ok, 13 AS assertions_passed, false AS production_jobs_changed, true AS rolled_back;`;
...
}, output: [{ json: { ok: true, assertions_passed: 13, production_jobs_changed: false, rolled_back: true } }] });
