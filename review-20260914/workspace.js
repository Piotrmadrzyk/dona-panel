  ...
  async function loadData(){
    ...
    if(state.demo){
      ...
      state.data.socialPosts=[
        {id:'demo-post-silver',title:'Światło zapisane w szkle',text:'Przykładowy szkic na podstawie materiału marki. Dokładna treść i zdjęcie czekają na Twoją decyzję.',image:new URL('./../pilot/assets/site-previews/silverandglass.webp',location.href).href,source:'https://www.silverandglass.pl/',profileId:'silverandglass',brandId:'silverandglass',status:'DRAFT'},
        {id:'demo-post-edward',title:'Rzeszów, którego już nie ma',text:'Przykładowy szkic opowieści o dawnym Rzeszowie. Nic nie zostanie opublikowane w trybie demo.',image:new URL('./../pilot/assets/site-previews/edwardjanusz.webp',location.href).href,source:'https://www.edwardjanusz.pl/',profileId:'edwardjanusz',brandId:'edwardjanusz',status:'DRAFT'}
      ];
      render();return;
    }
